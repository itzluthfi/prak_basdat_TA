...
UPDATE karyawan SET posisi = 'Manager' WHERE nama_karyawan = 'Dewi Marlina';
UPDATE karyawan SET posisi = 'Staff' WHERE nama_karyawan = 'Joko Supriyadi';
...
UPDATE karyawan SET 
    ...
    posisi = 'Manager',
    status = 'Aktif'
WHERE nama_karyawan = 'Dewi Marlina';
...
UPDATE karyawan SET 
    ...
    posisi = 'Staff',
    status = 'Aktif'
WHERE nama_karyawan = 'Joko Supriyadi';

-- Tambah karyawan Manager dan Admin untuk demo
INSERT INTO karyawan (nama_karyawan, posisi, shift_karyawan, username, password, status) 
VALUES 
    ('Ahmad Ridwan', 'Manager', 'Pagi', 'manager', 'manager123', 'Aktif'),
    ('Siti Nurhaliza', 'Admin', 'Sore', 'admin2', 'admin123', 'Aktif')
